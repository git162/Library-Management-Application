  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        toast.error("Unable to Sign In!!!", { position: "top-center" });
      }
    } finally {
      setIsLoading(false);
    }
    ...
    <>
      ...
      <div className="flex mt-20 justify-center gap-20">
        <div className="form-area  bg-slate-200 w-[40vw] h-[80vh] gap-1 rounded-md flex flex-col items-center">
          ...
          <h4 className="font-robotoCondensed text-xl">New Here? <Link className="no-underline text-orange-400" to={"/signup"}>Sign Up</Link></h4>
        </div>
